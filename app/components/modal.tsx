...
const Modal:React.FC<Props> = ({children})=>{
    ...
    return <>
        <div className="fixed p-2 left-0 top-0 bottom-0 w-full lg:overflow-visible overflow-auto h-full bg-white/30 backdrop-invert backdrop-opacity-10">
            <div className="flex lg:flex-row flex-col rounded-xl m-auto overflow-auto w-2/4  z-30">
